// ============================================================
// TRAVEL RAVERS — BudgetScreen (Stub)
// Session 1-C: Secondary module stub — full build in Session 2-C
// Festival expense splitter — fully offline via SQLite
// Accent: Gold (#FFD700)
// ============================================================
    ...
    <SafeAreaView style={styles.safeArea} edges={['top', 'left', 'right']}>
      <View style={styles.header}>
        ...
        <View>
          ...
          <Text style={styles.subtitle}>Expense Splitter</Text>
        </View>
      </View>
      <View style={styles.body}>
        <GlowBorderCard accentColor={Colors.module.BUDGET}>
          <View style={styles.content}>
            <Text style={styles.emoji}>💰</Text>
            <Text style={styles.comingSoonLabel}>COMING IN PHASE 2</Text>
            <Text style={styles.comingSoonTitle}>BUDGET</Text>
            <Text style={styles.desc}>
              Log shared expenses on the go.{'\n'}
              Split by category: transport, food, drinks.{'\n'}
              Settlement calculator — who owes who.{'\n'}
              Share summary via WhatsApp. 100% offline.
            </Text>
          </View>
        </GlowBorderCard>
      </View>
